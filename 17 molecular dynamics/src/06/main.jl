...
addLinearBond!(model,1,2; hookConstant = hookConstants[1])
addLinearBond!(model,2,3; hookConstant = hookConstants[2])
addPolarBond!(model,1,2,3)
addDipoles!(model,1,2,3; magneticField = magneticField)
